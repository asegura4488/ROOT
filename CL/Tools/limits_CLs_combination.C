void limits_CLs_combination(){
  ...
  cl_vs_s_CL_c1->SetMarkerStyle(8);
  cl_vs_s_CL_c1->SetMarkerColor(kBlue+2);
  cl_vs_s_CL_c1->SetMaximum(1);
  cl_vs_s_CL_c1->SetMinimum(0.0011);

  cl_vs_s_CL_c2->SetMarkerStyle(8);
  cl_vs_s_CL_c2->SetMarkerColor(kBlue);
  cl_vs_s_CL_c2->SetMaximum(1);
  cl_vs_s_CL_c2->SetMinimum(0.0011);

  cl_vs_s_CL_comb->SetMarkerStyle(8);
  cl_vs_s_CL_comb->SetMarkerColor(kBlack);
  cl_vs_s_CL_comb->SetMaximum(1);
  cl_vs_s_CL_comb->SetMinimum(0.0011);
