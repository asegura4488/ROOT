...
////////////////////////////////////////////////////////////////////////////////////////////////////
//                 DESCRIPCION DE CADA PARAMETRO QUE SE LE DA A LA FUNCION
//
//"fileName" = Nombre del archivo .root que contiene el modelo de senial mas backgorund
//"workspace name" = Nombre del workspace o que se uso en el archivo .root
//"S+B modelconfig name" = Nombre del objeto de la clase ModelConfig que contiene el modelo de senal mas background
//"B model name" = Nombre del modelo de solo el background que se puede usar para restringir los par'ametros de nuisance
//"data set name" = Datos de la senial experimental medida o simulada
//calculator type, usa alguna de las calculadoras que se explican mas abajo de forma type = #
//test statstic, es el tipo de estadistico que se va a usar para calcular los p-values, todos relacionados con el ratio de likelihoods pero implementados de forma algo diferente
// Es TRUE o FALSE, es una forma de calcular limitesde maxima verosimilitud de una sola cola que son m'as confiables al estar restringidos tanto por el poder estadistico como la significancia obtenida.
...
//
/////////////////////////////////////////////////////////////////////////////////////////////////////
//           ESTADISTICOS QUE SE VAN A USAR CON LAS CALCULADORAS PARA OBTENER EL P-VALUE
//
