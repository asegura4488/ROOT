...
// Tue Aug 20 16:46:57 2013 by ROOT version 5.34/00
// from TTree ntuple/Bs->J/psi Ks0 ntuple
// found on file: ../outputMC_ks0_cern.root
//////////////////////////////////////////////////////////
...
#ifdef MCBd_cxx
MCBd::MCBd(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../outputMC_ks0_cern.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../outputMC_ks0_cern.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../outputMC_ks0_cern.root:/mkcands");
...
Int_t MCBd::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MCBd::LoadTree(Long64_t entry)
{
